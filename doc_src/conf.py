...
version = geocamMapSet.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamMapSet.get_version()
...
htmlhelp_basename = 'geocamMapSetdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamMapSet Documentation',
   u'Trey Smith', 'manual'),
]
